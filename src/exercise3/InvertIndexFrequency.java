...
public class InvertIndexFrequency extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(secondjob, new Path("ex3intermidiate/part-r-00000"));
		FileOutputFormat.setOutputPath(secondjob, new Path("ex3final"));
		 ...
		 @Override
		    public void reduce(Text word, Iterable<Text> docs, Context context)
		     ...
		     for (Text doc : docs) {
		    	 ...
		    	 if(doc.toString().equals(previous)){
		    		 appearences++;
		    		 continue;
		    	 }
		    	 stringBuilder.append(previous + " #"+appearences +", ");
